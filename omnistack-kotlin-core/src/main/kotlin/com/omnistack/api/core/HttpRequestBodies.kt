...
import com.omnistack.api.core.http.HttpRequestBody
    ...
    return object : HttpRequestBody {
        ...
        private fun serialize(): ByteArray {
            ...
            try {
                ...
                throw OmnistackException("Error writing request", e)
            }
        }
            ...
            when (part.value) {
                is JsonValue -> {
                    ...
                    try {
                        ...
                        throw OmnistackException("Error serializing value to json", e)
                    }
