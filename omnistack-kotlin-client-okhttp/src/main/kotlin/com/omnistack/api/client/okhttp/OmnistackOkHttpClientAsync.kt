...
import com.omnistack.api.client.OmnistackClientAsync
import com.omnistack.api.client.OmnistackClientAsyncImpl
import com.omnistack.api.core.ClientOptions
import java.net.Proxy
import java.time.Clock
import java.time.Duration

class OmnistackOkHttpClientAsync private constructor() {

    companion object {

        fun builder() = Builder()

        fun fromEnv(): OmnistackClientAsync = builder().fromEnv().build()
    }
